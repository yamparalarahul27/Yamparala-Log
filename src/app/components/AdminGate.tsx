    ...
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <>
          ...
          <div
            className={cn(
              "fixed inset-x-0 bottom-0 z-50 h-[50vh] overflow-y-auto overscroll-contain rounded-t-2xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 p-4 pb-6 shadow-lg",
              "sm:absolute sm:inset-x-auto sm:bottom-auto sm:right-0 sm:top-full sm:mt-2 sm:h-auto sm:w-64 sm:rounded-xl sm:p-3 sm:pb-3",
            )}
          >
            <div className="mx-auto mb-3 h-1 w-10 rounded-full bg-stone-200 dark:bg-stone-700 sm:hidden" />
            {isAdmin ? (
              <div className="space-y-2">
                <p className="text-sm text-stone-600 dark:text-stone-300">Admin mode enabled</p>
